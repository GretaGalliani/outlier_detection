...
# Import dataset starsCYG included in package 'robustbase'
data = as.matrix(starsCYG)
n = dim(data)[1]
d = dim(data)[2]

plot(data, main='Star Cluster CYG OB1', pch=16)
...
Q_param$nu_0 = d+3
Q_param$lambda_0 = as.matrix(diag(diag(cov(data))))

# Contaminant diffuse component
P_param$k_0 = 0.25
P_param$mu_0 = colMeans(data)
P_param$nu_0 = d+3
P_param$lambda_0 = as.matrix(diag(diag(cov(data))))
